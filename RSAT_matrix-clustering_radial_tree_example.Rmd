...
After running this step, you will see this ~~ugly~~ tree as in Figure 3.
...
```{r Radial_tree_raw, eval=TRUE, echo=FALSE, fig.cap="Figure 3. Radial tree without outter ring and annotations.", cache=FALSE, include=TRUE, out.height="550px", out.width="550px", fig.align='center'}
