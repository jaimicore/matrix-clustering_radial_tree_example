...
```{r localhost_tree, eval=TRUE, echo=FALSE, fig.cap="Figure 2. As a localhost, open the matrix-clustering_radial_tree.html.", cache=FALSE, include=TRUE, out.height="500px", out.width="650px", fig.align='center'}
...
```{r Radial_tree_raw, eval=TRUE, echo=FALSE, fig.cap="Figure 3. Radial tree with outter ring and annotations after running the Example 2 of the stand-alone version.", cache=FALSE, include=TRUE, out.height="250px", out.width="550px", fig.align='center'}
...
We will modify the next features:
    ...
    6. Distance between ring and tree center (Figure 8)
    7. Tree branches thickness (Figure 9)


To do these changes, open the file `data/JASPAR_2022_CORE_nematodes_matrix-clustering/matrix-clustering_radial_tree_annotated.html`
...
$~$
```{r bg_end, eval=TRUE, echo=FALSE, fig.cap="Figure 8. Change the variable 'innerRad_end' to adapt where the background color ends.", cache=FALSE, include=TRUE, fig.align='center'}
...
$~$
```{r tree_branches, eval=TRUE, echo=FALSE, fig.cap="Figure 9. In the CSS section, change the parameter 'stroke-width'. Default: 1px.", cache=FALSE, include=TRUE, fig.align='center'}
